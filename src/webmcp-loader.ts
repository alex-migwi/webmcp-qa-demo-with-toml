    ...
    return {
        ...
        useFactory: () => {
            ...
            return async () => {
                ...
                const config = parse(await res.text()) as any;
                ...
                for (const toolConfig of config.tools) {
                    ...
                    // Strategy A vs B
                    const methodsToRegister = toolConfig.mode === 'auto'
                        ? allMethods
                    ...
                    methodsToRegister.forEach(methodName => {
                        ...
                        const description = toolConfig.description_overrides?.[methodName]
                            || `${methodName} on ${toolConfig.class}`;
